...
function enableQuery() {
    ...
    repoStatus.innerHTML = '<span class="w-2 h-2 rounded-full bg-dot-active"></span><span class="text-content-secondary">Indexed</span>';
}

function setStatus(state, message) {
    indexStatus.classList.remove("hidden");
    indexStatusDot.className = "w-2 h-2 rounded-full shrink-0";
